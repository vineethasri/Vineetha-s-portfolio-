...
$(function () {
  ...
  // --------------------------------------------- //
  // Sticky Avatar for Education Section Start
  // --------------------------------------------- //
  ScrollTrigger.create({
    trigger: "#resume",
    start: "top center",
    // Keep the avatar minimized (sticky) until the very end of the page (including Contact section)
    end: "max",
    onEnter: () => $(".avatar").addClass("is-sticky-avatar"),
    onLeave: () => $(".avatar").removeClass("is-sticky-avatar"),
    onEnterBack: () => $(".avatar").addClass("is-sticky-avatar"),
    onLeaveBack: () => $(".avatar").removeClass("is-sticky-avatar")
  });

  ScrollTrigger.create({
    trigger: "#contact",
    start: "top bottom", // Starts hiding as soon as contact section enters view
    end: "max",
    onEnter: () => $(".avatar").addClass("is-hidden-avatar"),
    onLeave: () => $(".avatar").removeClass("is-hidden-avatar"),
    onEnterBack: () => $(".avatar").removeClass("is-hidden-avatar"),
    onLeaveBack: () => $(".avatar").removeClass("is-hidden-avatar") // Correct logic: when we scroll back UP out of contact, we want it VISIBLE again (so remove hidden class)
  });
  // --------------------------------------------- //
  // Sticky Avatar for Education Section End
  // --------------------------------------------- //
